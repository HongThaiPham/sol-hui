...
export function TontineCard({ tontine, style }: TontineCardProps) {
  ...
  return (
    <TouchableOpacity
      onPress={() => router.push(`/(tabs)/tontines/${tontine.id}`)}
      style={style}
    >
            ...
            <View style={{ 
              ...
              {tontine.myTurn && (
                <View style={{
                  ...
                  <UiIconSymbol name="trophy.fill" size={14} color="#10B981" />
                  <AppText variant="bodySmall" style={{ 
                    color: '#10B981',
                    fontWeight: '600',
                    marginLeft: spacing.xs,
              ...
              {tontine.biddingOpen && (
                <View style={{
                  ...
                  <UiIconSymbol name="chart.line.uptrend.xyaxis" size={14} color="#8B5CF6" />
                  <AppText variant="bodySmall" style={{ 
                    color: '#8B5CF6',
                    fontWeight: '600',
                    marginLeft: spacing.xs,
