 ...
 */
export type Sontine = {
  address: '9PZCzbuowY4pmsmJ4P6DAJm2jZVpxHbskKfpos3hVBo1'
  metadata: {
    name: 'sontine'
    version: '0.1.0'
    spec: '0.1.0'
  ...
  types: [
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'contributionAmount'
            docs: ['Amount each member must contribute per round (in lamports)']
            type: 'u64'
          },
          {
            name: 'cycleDuration'
          ...
          {
            name: 'fixedOrder'
            docs: ['For fixed order selection: list of member pubkeys in order']
            type: {
              vec: 'pubkey'
            }
          },
    ...
    {
      name: 'member'
      docs: ['Member account that tracks individual member state within a group']
      type: {
        kind: 'struct'
        fields: [
          {
          ...
          {
            name: 'currentBid'
            docs: ["For auction method: member's current bid (interest rate in basis points)"]
            type: {
              option: 'u16'
            }
          },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'interestRate'
            docs: ['Interest rate for this round (basis points) - for auction method']
            type: {
              option: 'u16'
            }
          },
